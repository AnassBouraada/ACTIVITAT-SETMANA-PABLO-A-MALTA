...
async function obtenirDadesPelicules(numPage) {
  await fetch(
    `https://www.omdbapi.com/?apikey=ed8c126a&s=movie&page=${numPage}`
  )
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      pelicules.forEach((pelicula) => {
        ...
        editar.id = "edit";
        editar.innerHTML =
          '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M7.127 22.562l-7.127 1.438 1.438-7.128 5.689 5.69zm1.414-1.414l11.228-11.225-5.69-5.692-11.227 11.227 5.689 5.69zm9.768-21.148l-2.816 2.817 5.691 5.691 2.816-2.819-5.691-5.689z" fill="#000000"/></svg>';
        editar.onclick = () => {
        ...
        eliminar.innerHTML =
          '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z"/></svg>';
        eliminar.onclick = () => {
...
function afegirPelicules(titolPelicula) {
  ...
  imgNovaPelicula.src =
    "https://www.imprentaonline.net/blog/wp-content/uploads/DALL%C2%B7E-2023-10-16-10.41.49-Illustration-depicting-a-humanoid-robot-with-half-of-its-face-transparent-revealing-intricate-circuits-and-gears-inside.-The-robot-is-holding-a-light-1.png";
